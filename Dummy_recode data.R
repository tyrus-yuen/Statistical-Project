...
result<-fastDummies::dummy_columns(rawdata,select_columns = names(rawdata)[c(4,10,13:15,29:31,33)],remove_first_dummy = TRUE)

write.csv(result,file="dummy_nodatedata.csv")
